...
<Link to='/register'>
<button class='p-3  bg-clip-padding bg-gradient-to-t from-pink-400 to-pink-600 font-bold rounded-xl text-slate-200'>Register</button></Link><Link to='/dashboard'> <button class='p-3 bg-clip-padding bg-gradient-to-t from-pink-900 to-purple-600 font-bold text-slate-300 rounded-xl '>{props.logged.isLogged?<span class='cursor-pointer'>Dashboard</span>:<Link to='/signIn'><span class='p-4'>Sign-In</span></Link>}</button></Link>
    </div>
